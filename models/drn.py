...
def drn_d_54(pretrained=False, out_map=256, num_classes=20, drn_model_dir='/serving/user_resource/checkpoint/',**kwargs):
    ...
    if pretrained:
        ...
        drn_model_dir = os.path.join(parent_folder_path, "checkpoint")
