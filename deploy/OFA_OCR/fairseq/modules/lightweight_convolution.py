...
from OFA_OCR.fairseq.incremental_decoding_utils import with_incremental_state
from OFA_OCR.fairseq.modules.fairseq_dropout import FairseqDropout
from OFA_OCR.fairseq.modules.unfold import unfold1d
...
def LightweightConv(
    ...
    if torch.cuda.is_available():
        try:
            from OFA_OCR.fairseq.modules.lightconv_layer import LightconvLayer
