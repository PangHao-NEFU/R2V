...
from OFA_OCR.fairseq.dataclass import FairseqDataclass
from OFA_OCR.fairseq.dataclass.configs import FairseqConfig
...
def override_module_args(args: Namespace) -> Tuple[List[str], List[str]]:
    ...
    if args is not None:
        if hasattr(args, "task"):
            from OFA_OCR.fairseq.tasks import TASK_DATACLASS_REGISTRY
        ...
        from OFA_OCR.fairseq.registry import REGISTRIES
        ...
        if hasattr(args, "arch"):
            from OFA_OCR.fairseq.models import ARCH_MODEL_REGISTRY, ARCH_MODEL_NAME_REGISTRY
...
def convert_namespace_to_omegaconf(args: Namespace) -> DictConfig:
    ...
    with omegaconf_no_object_check():
        ...
        if cfg.lr_scheduler is None and getattr(args, "lr_scheduler", None):
            ...
            from OFA_OCR.fairseq.optim.lr_scheduler import LR_SCHEDULER_REGISTRY
        ...
        if cfg.criterion is None and getattr(args, "criterion", None):
            ...
            from OFA_OCR.fairseq.criterions import CRITERION_REGISTRY
