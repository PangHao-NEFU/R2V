...
from OFA_OCR.fairseq.data.indexed_dataset import get_available_dataset_impl
from OFA_OCR.fairseq.dataclass.configs import (
    CheckpointConfig,
    CommonConfig,
    CommonEvalConfig,
    DatasetConfig,
...
from OFA_OCR.fairseq.dataclass.utils import gen_parser_from_dataclass

# this import is for backward compatibility
from OFA_OCR.fairseq.utils import csv_str_list, eval_bool, eval_str_dict, eval_str_list  # noqa
...
def parse_args_and_arch(
    ...
    from OFA_OCR.fairseq.models import ARCH_MODEL_REGISTRY, ARCH_CONFIG_REGISTRY, MODEL_REGISTRY
    ...
    if getattr(args, "use_bmuf", False):
        ...
        from OFA_OCR.fairseq.optim.bmuf import FairseqBMUF
