...
import torch
from OFA_OCR.fairseq.data import data_utils
from OFA_OCR.fairseq.dataclass.configs import CheckpointConfig
from OFA_OCR.fairseq.dataclass.utils import (
    convert_namespace_to_omegaconf,
    overwrite_args_by_name,
)
from OFA_OCR.fairseq.distributed.fully_sharded_data_parallel import FSDP, has_FSDP
from OFA_OCR.fairseq.file_io import PathManager
from OFA_OCR.fairseq.models import FairseqDecoder, FairseqEncoder
...
def load_model_ensemble_and_task(
    ...
    from OFA_OCR.fairseq import tasks
