...
from OFA_OCR.fairseq.scoring import BaseScorer, register_scorer
from OFA_OCR.fairseq.scoring.tokenizer import EvaluationTokenizer
...
class Scorer(object):
    def __init__(self, cfg):
        ...
        try:
            from OFA_OCR.fairseq import libbleu
