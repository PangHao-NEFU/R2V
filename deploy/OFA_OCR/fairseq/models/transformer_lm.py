...
from OFA_OCR.fairseq import options, utils
from OFA_OCR.fairseq.dataclass import ChoiceEnum, FairseqDataclass
...
from OFA_OCR.fairseq.modules import AdaptiveInput, CharacterTokenEmbedder
