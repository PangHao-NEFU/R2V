...
from OFA_OCR.fairseq.models import (
    FairseqEncoder,
    FairseqEncoderModel,
    register_model,
    register_model_architecture,
)
from OFA_OCR.fairseq.models.transformer import DEFAULT_MIN_PARAMS_TO_WRAP, TransformerEncoder
from OFA_OCR.fairseq.modules import LayerNorm
from OFA_OCR.fairseq.modules.quant_noise import quant_noise as apply_quant_noise_
from OFA_OCR.fairseq.modules.transformer_sentence_encoder import init_bert_params
from OFA_OCR.fairseq.utils import safe_getattr, safe_hasattr
...
class RobertaModel(FairseqEncoderModel):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        from OFA_OCR.fairseq import hub_utils
