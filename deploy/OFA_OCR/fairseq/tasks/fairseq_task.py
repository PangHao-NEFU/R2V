...
import torch
from OFA_OCR.fairseq import metrics, search, tokenizer, utils
from OFA_OCR.fairseq.data import Dictionary, FairseqDataset, data_utils, encoders, iterators
...
class FairseqTask(object):
    ...
    def dataset(self, split):
        ...
        """
        from OFA_OCR.fairseq.data import FairseqDataset
    ...
    def build_model(self, cfg: FairseqDataclass):
        ...
        """
        from OFA_OCR.fairseq import models, quantization_utils
    ...
    def build_criterion(self, cfg: DictConfig):
        ...
        """
        from OFA_OCR.fairseq import criterions
    ...
    def build_generator(
        ...
        if getattr(args, "score_reference", False):
            from OFA_OCR.fairseq.sequence_scorer import SequenceScorer
        ...
        from OFA_OCR.fairseq.sequence_generator import (
            SequenceGenerator,
