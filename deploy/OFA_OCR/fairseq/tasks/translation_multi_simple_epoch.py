...
from OFA_OCR.fairseq.data.multilingual.multilingual_data_manager import (
    MultilingualDatasetManager,
)
from OFA_OCR.fairseq.data.multilingual.sampling_method import SamplingMethod
from OFA_OCR.fairseq.tasks import LegacyFairseqTask, register_task
from OFA_OCR.fairseq.utils import FileContentsAction
