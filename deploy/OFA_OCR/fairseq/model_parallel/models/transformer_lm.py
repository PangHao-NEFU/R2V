...
from OFA_OCR.fairseq.model_parallel.models.transformer import ModelParallelTransformerDecoder
from OFA_OCR.fairseq.models import register_model, register_model_architecture
from OFA_OCR.fairseq.models.transformer_lm import TransformerLanguageModel


try:
    from OFA_OCR.fairseq.model_parallel.megatron.mpu import VocabParallelEmbedding
