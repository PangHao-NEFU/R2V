...
from OFA_OCR.fairseq.model_parallel.modules import ModelParallelMultiheadAttention
from OFA_OCR.fairseq.modules import TransformerDecoderLayer, TransformerEncoderLayer
