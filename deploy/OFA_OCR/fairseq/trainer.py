...
import torch
from OFA_OCR.fairseq import checkpoint_utils, models, optim, utils
from OFA_OCR.fairseq.dataclass.configs import FairseqConfig
from OFA_OCR.fairseq.dataclass.utils import convert_namespace_to_omegaconf
from OFA_OCR.fairseq.distributed import utils as distributed_utils
from OFA_OCR.fairseq.file_io import PathManager
from OFA_OCR.fairseq.logging import meters, metrics
from OFA_OCR.fairseq.models.ema import build_ema
from OFA_OCR.fairseq.nan_detector import NanDetector
from OFA_OCR.fairseq.optim import lr_scheduler
...
class Trainer(object):
    ...
    def get_meter(self, name):
        ...
        from OFA_OCR.fairseq import meters
    ...
    def _xla_markstep_and_send_to_cpu(self, data=None):
        ...
        xm.mark_step()
        if data is not None:
            from OFA_OCR.fairseq.utils import xla_device_to_cpu
