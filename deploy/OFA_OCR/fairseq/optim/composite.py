...
from OFA_OCR.fairseq.optim import FairseqOptimizer, register_optimizer, _build_optimizer
from OFA_OCR.fairseq.optim.lr_scheduler import FairseqLRScheduler, build_lr_scheduler
