...
import numpy as np
import torch
from OFA_OCR.fairseq.data import FairseqDataset, plasma_utils
from OFA_OCR.fairseq.data.indexed_dataset import best_fitting_int_dtype
...
class TokenBlockDataset(FairseqDataset):
    ...
    def _build_slice_indices(
        ...
        try:
            from OFA_OCR.fairseq.data.token_block_utils_fast import (
