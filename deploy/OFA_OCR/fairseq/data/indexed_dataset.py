...
import numpy as np
import torch
from OFA_OCR.fairseq.dataclass.constants import DATASET_IMPL_CHOICES
from OFA_OCR.fairseq.data.fasta_dataset import FastaDataset
from OFA_OCR.fairseq.file_io import PathManager
from OFA_OCR.fairseq.data.huffman import HuffmanMMapIndexedDataset, HuffmanMMapIndex
...
def make_dataset(path, impl, fix_lua_indexing=False, dictionary=None):
    if impl == "raw" and IndexedRawTextDataset.exists(path):
        ...
        from OFA_OCR.fairseq.data.fasta_dataset import EncodedFastaDataset
