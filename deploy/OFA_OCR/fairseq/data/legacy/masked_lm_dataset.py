...
import numpy as np
import torch
from OFA_OCR.fairseq.data import Dictionary, FairseqDataset, data_utils
from OFA_OCR.fairseq.data.concat_dataset import ConcatDataset
from OFA_OCR.fairseq.data.legacy.block_pair_dataset import BlockPairDataset
from OFA_OCR.fairseq.data.token_block_dataset import TokenBlockDataset
