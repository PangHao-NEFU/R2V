...
from OFA_OCR.fairseq.data import (
    AppendTokenDataset,
    ConcatDataset,
    Dictionary,
    LanguagePairDataset,
...
from OFA_OCR.fairseq.data.multilingual.multilingual_utils import (
    EncoderLangtok,
    LangTokSpec,
    LangTokStyle,
    augment_dictionary,
...
from OFA_OCR.fairseq.data.multilingual.sampled_multi_dataset import CollateFormat
from OFA_OCR.fairseq.file_io import PathManager
from OFA_OCR.fairseq.utils import FileContentsAction, csv_str_list, eval_str_dict
