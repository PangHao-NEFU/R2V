...
from OFA_OCR.data.file_dataset import FileDataset

import torch
from OFA_OCR.fairseq import metrics
from OFA_OCR.fairseq.tasks import register_task

from OFA_OCR.models_ import search
from OFA_OCR.data.mm_data.vqa_gen_dataset import VqaGenDataset
from OFA_OCR.data import data_utils
from OFA_OCR.tasks.ofa_task import OFAConfig, OFATask
from OFA_OCR.utils_.trie import Trie
