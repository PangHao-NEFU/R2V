...
from OFA_OCR.tasks.ofa_task import OFATask, OFAConfig
from OFA_OCR.data.mm_data.caption_dataset import CaptionDataset
from OFA_OCR.data.file_dataset import FileDataset
from OFA_OCR.utils_.cider.pyciderevalcap.ciderD.ciderD import CiderD
