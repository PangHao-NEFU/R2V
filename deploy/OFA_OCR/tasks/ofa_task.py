...
from OFA_OCR.fairseq import search
from OFA_OCR.fairseq.data import FairseqDataset, iterators
from OFA_OCR.fairseq.optim.amp_optimizer import AMPOptimizer
from OFA_OCR.fairseq.dataclass import FairseqDataclass
from OFA_OCR.fairseq.tasks import FairseqTask, register_task
...
class OFATask(FairseqTask):
    ...
    def build_generator(
        ...
        from OFA_OCR.models_.sequence_generator import SequenceGenerator
