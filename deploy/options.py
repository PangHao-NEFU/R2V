...
def parse_args():
    ...
    parser.add_argument('--weightFile', dest='weight_file_path',
                        help='weight file path',
                        default='', type=str, required=False)
    parser.add_argument('--methodType', dest='method_type',
                        help='method type',
                        default=1, type=int, required=False)
    parser.add_argument('--debug', dest='debugFlag',
                        help='flag for debugging',
                        default=0, type=int)
    parser.add_argument('--gpu', dest='gpuFlag',
