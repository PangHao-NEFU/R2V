...
def parse_args():
    ...
    parser.add_argument(
        '--weightFile', dest='weight_file_path',
        help='weight file path',
        default='', type=str, required=False
    )
    parser.add_argument(
        '--methodType', dest='method_type',
        help='method type',
        default=1, type=int, required=False
    )
    parser.add_argument(
        '--debug', dest='debugFlag',
    ...
    parser.add_argument(
        '--testingDataset', dest='testingDataset',
        help='dataset name for test/predict',
        default='scannet', type=str
    )
    parser.add_argument(
        '--numTrainingImages', dest='numTrainingImages',
        help='the number of floorplanImages to train',
        default=10000, type=int
    )
    parser.add_argument(
        '--numTestingImages', dest='numTestingImages',
        help='the number of floorplanImages to test/predict',
    ...
    parser.add_argument(
        '--numEpochs', dest='numEpochs',
        help='the number of epochs',
        default=1000, type=int
    )
    parser.add_argument(
        '--startEpoch', dest='startEpoch',
    ...
    parser.add_argument(
        '--heatmapThreshold', dest='heatmapThreshold',
        help='heatmap threshold for positive predictions',
        default=0.5, type=float
    )
    parser.add_argument(
        '--distanceThreshold3D', dest='distanceThreshold3D',
        help='distance threshold 3D',
        default=0.2, type=float
    )
    parser.add_argument(
        '--distanceThreshold2D', dest='distanceThreshold2D',
        help='distance threshold 2D',
        default=20, type=float
    )
    parser.add_argument(
        '--numInputPlanes', dest='numInputPlanes',
        help='the number of input planes',
        default=1024, type=int
    )
    parser.add_argument(
        '--numOutputPlanes', dest='numOutputPlanes',
        help='the number of output planes',
        default=10, type=int
    )
    parser.add_argument(
        '--numInputClasses', dest='numInputClasses',
        help='the number of input classes',
        default=0, type=int
    )
    parser.add_argument(
        '--numOutputClasses', dest='numOutputClasses',
    ...
    parser.add_argument(
        '--outputWidth', dest='outputWidth',
        help='output width',
        default=256, type=int
    )
    parser.add_argument(
        '--outputHeight', dest='outputHeight',
        help='output height',
    ...
    ## Flags
    parser.add_argument(
        '--visualizeMode', dest='visualizeMode',
